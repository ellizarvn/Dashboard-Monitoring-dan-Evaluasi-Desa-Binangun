...
<div class="mb-7">
    ...
    <h1 class="font-display text-2xl text-forest">Tambah Pengguna Baru</h1>
    <p class="text-sm text-sage-600 mt-0.5">Daftarkan akun administrator atau staf desa baru ke dalam portal</p>
</div>
    ...
    <div class="lg:col-span-2 bg-white rounded-2xl shadow-card border border-sage-100/60 p-6">
        ...
        <form action="{{ route('users.store') }}" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <input type="text" name="name" value="{{ old('name') }}" required placeholder="Nama lengkap staf"
            ...
            <div>
                ...
                <input type="email" name="email" value="{{ old('email') }}" required placeholder="email@desabinangun.id"
            ...
            <div>
                ...
                <input type="text" name="phone" value="{{ old('phone') }}" placeholder="e.g. 08123456789"
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <select name="role" id="role-select" required onchange="toggleJabatanField()"
                            class="w-full px-4 py-3 rounded-xl border border-gray-200 text-sm font-medium bg-white focus:ring-forest/10
                                   focus:outline-none focus:border-forest focus:ring-2">
                        <option value="admin" {{ old('role') === 'admin' ? 'selected' : '' }}>Admin (Staf Desa)</option>
                ...
                <div id="jabatan-container">
                    ...
                    <select name="jabatan" id="jabatan-select"
                        ...
                        <option value="Tim Monitoring" {{ old('jabatan') === 'Tim Monitoring' ? 'selected' : '' }}>Tim Monitoring</option>
